...
//  static final String _baseUrl="http://baishuang.51vip.biz";
  ...
  final String createCustomerUrl =
      '$_baseUrl/obp/v4.0.0/banks/BANK_ID/customers';
  final String createUserCustomerLinkUrl =
      '$_baseUrl/obp/v4.0.0/banks/BANK_ID/user_customer_links';
  final String createAuthContextUpdateUrl =
      '$_baseUrl/obp/v4.0.0/banks/BANK_ID/users/current/auth-context-updates/SCA_METHOD';
  final String answerAuthContextUpdateChallengeUrl =
      '$_baseUrl/obp/v4.0.0/users/current/auth-context-updates/AUTH_CONTEXT_UPDATE_ID/challenge';
  final String getCurrentUserLinkedCustomerUrl =
      '$_baseUrl/obp/v4.0.0/users/current/customers';
